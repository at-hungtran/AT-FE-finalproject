  ...
  search() {
    ...
    if(!this.destinationInput) {
      ...
      if(!this.siteId && !this.categoryId) {
        let str = `search/${this.destinationInput}`;
        this.router.navigate([str]);
      }
      if(this.siteId && !this.categoryId) {
        let str = `search/${this.destinationInput}&site${this.siteId}`;
        this.router.navigate([str]);
      }
      if(!this.siteId && this.categoryId) {
        let str = `search/${this.destinationInput}&cate${this.categoryId}`;
        this.router.navigate([str]);
      }
      if(this.siteId && this.categoryId) {
        let str = `search/${this.destinationInput}&site${this.siteId}&cate${this.categoryId}`;
        this.router.navigate([str]);
      }
    }
  }
